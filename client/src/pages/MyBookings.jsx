...
const MyBookings = () => {
  ...
  return (
    ...
    className='px-6 md:px-16 lg:px-16 xl:px-32 2xl:px-48 mt-16 text-sm max-w-7xl'>
        <Title title='My Bookings' 
        subTitle='View and manage all your car bookings' align="left"/>
             ...
             <p className='text-gray-500'>{booking.car.year}. {booking.car.category}. {booking.car.location}</p>
                ...
                <div className='md:col-span-1 flex flex-col justify-between gap-6'>
                    <div className='text-sm text-gray-500 text-right'>
                        <p>Total Price</p>
                        <h1 className='tetx-2xl font-semibold text-primary'>{currency}{booking.price}</h1>
